...
nib.save(img, os.path.join('path','volume-{}.nii.gz'.format(pid)))
labels = nib.Nifti1Image(final_mask, None)
nib.save(labels, os.path.join('path', 'labels-{}.nii.gz'.format(pid)))
...
print(reshaped_final_image.shape)
...
print(final_image[:10,:10,:10])
print(img.dataobj[:10,:10,:10])
print(final_mask[:10,:10,:10])
print(labels.dataobj[:10,:10,:10])


# In[20]:


plt.imshow(final_image[:,:,135])


# In[22]:


plt.imshow(img.dataobj[:,:,135,0])


# In[23]:


plt.imshow(final_mask[:,:,135])


# In[25]:


plt.imshow(labels.dataobj[:,:,135])
