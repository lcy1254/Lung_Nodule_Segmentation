...
declare -r path_frozen=$path_data/blaine/frozen
declare -r path_model=$path_data/blaine/model

#declare -r name=CT_Liver_Lesion_Unet_fuzzy
#declare -r name=CT_Liver_Lesion_Unet
declare -r name=CT_Lung_Seg_Unet4

declare -r path_log=$path_data/blaine/logs
declare -r path_vis=$path_data/blaine/visualization
mkdir $path_model
mkdir $path_log
mkdir $path_vis
...
declare -r train_gpus='0 1 2 3' # The GPUs to use for training
declare -r augment_gpu='' # The GPU to use for data augmentation. If empty, uses the CPU
declare -r batch_size=8
...
declare -r cropping='nonzero' # 'uniform' (default), 'valid', 'none', 'nonzero'
