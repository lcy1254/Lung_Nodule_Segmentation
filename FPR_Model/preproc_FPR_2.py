...
import re
import sys
from FPR_Preproc_biggerstretch_utils import saveNodule #FPRpreproc_utils or FPR_Preproc_biggerstretch_utils or FPR_Preproc_NoPadding_utils
#change this ^^^
...
outDir = {'training': '/media/data_crypt_2/FPR_data_bigger/training', 'testing': '/media/data_crypt_2/FPR_data_bigger/testing', 'validation': '/media/data_crypt_2/FPR_data_bigger/validation'}
#change this ^^^^
